   ...
   public static class SQL_Helper
    {
        ...
        //public static SqlConnection SqlCn = new SqlConnection(@"data source=VAIO\SQL2008R2;database=POS;user id=sa; password=admin1$");
        //public static SqlConnection SqlCn = new SqlConnection(@"data source= TEST-PC;database=POS;user id=sa; password=admin1$");
        ...
        public static object executeScalar(String columnName, String dataTable)
        {
            object Result;
            ...
            try
            {
                ...
                SqlCommand SqlCmd = new SqlCommand("select "+ columnName + "  from " + dataTable + "", SqlCn);
                SqlCn.Open();
                Result = SqlCmd.ExecuteScalar();
                SqlCn.Close();
            }
